...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressLabel = findViewById(R.id.splashProgressLabel)
        ...
        listOf(logoImg, titleText, subText, progressBar, progressLabel).forEach { it.alpha = 0f }
    ...
    private fun startSplashSequence() {
        ...
        handler.postDelayed({
            ...
            ObjectAnimator.ofFloat(progressLabel, "alpha", 0f, 1f).apply { duration=300; start() }
